package org.getaviz.generator.repository;
...
public class SourceNodeRepository {
    ...
    public void loadNodesByType(Enum<?> type) {
    ...
    public void loadNodesByPropertyValue(Enum<?> property, String value){
    ...
    public void loadNodesByRelation(Enum<?> relationType){
        loadNodesByRelation(relationType, false);
    }

    public void loadNodesByRelation(Enum<?> relationType, boolean recursive){
        loadNodesByRelation(relationType, recursive, true);
    }

    public void loadNodesByRelation(Enum<?> relationType, boolean recursive, boolean forward){
    ...
    public void loadNodesByRelation(Set<Long> nodeIds, Enum<?> relationType, boolean recursive, boolean forward){
    ...
    public void loadNodesWithRelation(Enum<?> relationLabel){
    ...
    public Collection<Node> getRelatedNodes(Node node, Enum<?> relationLabel, Boolean direction){
    ...
    public Collection<Node> getNodesByLabel(Enum<?> label){
    ...
    public Collection<Node> getNodesByProperty(Enum<?> property, String value){
    ...
    // Laden Property
    public Collection<Node> getNodesByIdenticalPropertyValuesNodes(Enum<?> property, String value){
    ...
    public Collection<Node> getNodesByLabelAndProperty(Enum<?> label, String property, String value){
