...
public class ACityRepository {
    ...
    public Collection<ACityElement> getElementsByTypeAndSourceProperty(ACityElement.ACityType type, String sourcePropertyValue){
...
//            }
    ...
    // Write der ACityElements in die Neo4j-DB
