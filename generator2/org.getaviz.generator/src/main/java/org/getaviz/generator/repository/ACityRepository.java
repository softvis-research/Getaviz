...
public class ACityRepository {
    ...
    public Collection<ACityElement> getElementsByTypeAndSourceProperty(ACityElement.ACityType type, Enum<?> sourceProperty, String sourcePropertyValue){
    ...
    public Collection<ACityElement> getElementsBySourceProperty(Enum<?> sourceProperty, String sourcePropertyValue){
    ...
    public Collection<ACityElement> getRootDistricts(Enum<?> iterationProperty) {
        Collection<ACityElement> districts  = getElementsByType(ACityElement.ACityType.District);
        List<ACityElement> rootDistricts = new ArrayList<>();
        for (ACityElement district: districts) {
            int iteration = Integer.parseInt(district.getSourceNodeProperty(iterationProperty));
            if (iteration == 0) {
