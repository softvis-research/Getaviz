...
CREATE (p2:Class:Type { fqn : 'bank.product.AbstractProduct', name: 'AbstractProduct', hash: 'ID_8fa088272bab165867bfaddcfbf58d6a7d5d45a2' })
...
CREATE (businessName:Field { fqn : 'bank.customer.BusinessCustomer.name', name: '_$name', hash: 'ID_11629cab6286835bcf468dd158c63816c6bc8b50', visibility: 'public' })
...
CREATE (businessAccounts:Field { fqn : 'bank.customer.BusinessCustomer.accounts', name: '_$accounts', hash: 'ID_4d08a19b31cdb900d36f69756e8323ca65e9186b', visibility: 'public' })
...
CREATE (privateAccounts:Field { fqn:  'bank.customer.PrivateCustomer.accounts', name: '_$accounts', hash: 'ID_5754aad0f8ca2e5adb39c097f3221eda4c82877d', visibility: 'public' })
...
CREATE (privateCredits:Field { fqn : 'bank.customer.PrivateCustomer.credits', name: '_$credits', hash : 'ID_0166fed357196a09244efe558dbeb27e6e0d646b', visibility: 'public' })
...
CREATE (privateName:Field { fqn : 'bank.customer.PrivateCustomer.name', name: '_$name' , hash: 'ID_0cf4af5bed915ef9b74c93b2c50852c21f2d5364', visibility: 'public' })
...
CREATE (bc)-[:READS]->(privateAccounts)
...
CREATE (bk)-[:READS]->(businessAccounts)
CREATE (bk)-[:READS]->(privateName)
CREATE (bk)-[:READS]->(businessName)
...
CREATE (m26)-[:READS]->(privateAccounts)
CREATE (m26)-[:READS]->(businessAccounts)
CREATE (m26)-[:READS]->(privateName)
CREATE (m26)-[:READS]->(businessName)
CREATE (m26)-[:READS]->(privateCredits)
