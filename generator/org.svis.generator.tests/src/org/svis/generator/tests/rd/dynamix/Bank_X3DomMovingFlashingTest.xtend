...
class Bank_X3DomMovingFlashingTest {
	...
	def static void launch() {
		...
		*/
		SettingsConfiguration.getInstance("../org.svis.generator.tests/testdata/bank/input/BankMovingFlashingTest.properties")
		new Mwe2Launcher().run(#["../org.svis.generator.run/src/org/svis/generator/run/rd/Dynamix2RD.mwe2", "-p", "famixPath=testdata/bank/input/famixDyn",
			"dynamixPath=testdata/bank/input/dynamix","outputPath=output/rd/dynamix/bank/bank_x3dom_moving_flashing"])
		/*
	...
	def testX3DOM() {
		...
		var File file2 = null
		try {
			file1 = new File("./output/rd/dynamix/bank/bank_x3dom_moving_flashing/x3dom-model.html")
			file2 = new File("./testdata/bank/output/rd/dynamix/bank_x3dom_moving_flashing/x3dom-model.html")
	...
	def testEventJS() {
		...
		var File file2 = null
		try {
			file1 = new File("./output/rd/dynamix/bank/bank_x3dom_moving_flashing/events.js")
			file2 = new File("./testdata/bank/output/rd/dynamix/bank_x3dom_moving_flashing/events.js")
		} catch (FileNotFoundException e) {
			e.printStackTrace
		}
