...
class Bank_MethodTypeTest {
	...
	val static path = "./output/rd/famix/bank/bank_method_type_mode/"
	...
	def static void launch() {
		...
		json = JSONUtil::read("./testdata/bank/output/rd/famix/bank_method_type_mode/metaData.json")
	}
	...
	def testMetaData() {
		...
		try {
			...
			file2 = new File("./testdata/bank/output/rd/famix/bank_method_type_mode/metaData.json")
    ...
    def void testMethodNumberOfAccesses() {
    	val result = JSONUtil::toList(JsonPath::read(json, "$..[?(@.id=='ID_4c3a759a929fdfc8754f03495aa0d746592eab6a')].accesses"))
    ...
    */ 
	...
	def testX3D() {
		...
		try {
			...
			file2 = new File("./testdata/bank/output/rd/famix/bank_method_type_mode/model.x3d")
		} catch (FileNotFoundException e) {
			e.printStackTrace
		}
    ...
    def rdNumberOfData() {
    	...
    	Assert.assertEquals(20, attributes.length)
    }
    ...
    def rd() {
    	...
    	var File file2 = null
		try {
			file1 = new File("./testdata/bank/output/rd/famix/bank_method_type_mode/rd.xml")
	...
	def rdExtended() {
		...
		var File file2 = null
		try {
			file1 = new File("./testdata/bank/output/rd/famix/bank_method_type_mode/rdextended.xml")
