...
class Bank_OriginalTest {
	...
	def testMetaData() {
		...
		try {
			...
			file2 = new File("./testdata/bank/output/rd/famix/original/metaData.json")
    ...
    */ 
    ...
    def testX3D() {
        ...
        try {
			...
			file2 = new File("./testdata/bank/output/rd/famix/original/model.x3d")
        } catch (FileNotFoundException e) {
            e.printStackTrace
        }
    ...
    def rd() {
    	...
    	var File file2 = null
        try {
			file1 = new File("./testdata/bank/output/rd/famix/original/rd.xml")
    ...
    def rdExtended() {
        ...
        try {
			file1 = new File("./testdata/bank/output/rd/famix/original/rdextended.xml")
