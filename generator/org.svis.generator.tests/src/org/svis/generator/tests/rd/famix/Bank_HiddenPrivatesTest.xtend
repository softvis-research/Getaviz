...
class Bank_HiddenPrivatesTest {
	...
	val static path = "./output/rd/famix/bank/bank_hidden_privates/"
	...
	def static void launch() {
		...
		json = JSONUtil::read("./testdata/bank/output/rd/famix/bank_hidden_privates/metaData.json")
	}
	...
	def testMetaData() {
		...
		try {
			...
			file2 = new File("./testdata/bank/output/rd/famix/bank_hidden_privates/metaData.json")
	...
	def void testMethodNumberOfAccesses() {
		val result = JSONUtil::toList(JsonPath::read(json, "$..[?(@.id=='ID_a113953a4fd76dc7bd442656a08af378baed6667')].accesses"))
    ...
    def void testAttributBelongsTo(){
		assertThat(json, hasJsonPath("$..[?(@.id=='ID_37834fec4533797c12daa8509eb11587547caac1')].belongsTo", hasItem("ID_ecbec7f0190fc1c903a87797d35427dc7a1f240b")))
    }
    ...
    */ 
    ...
    def void testMethodCalledBy(){
    	...
    	assertTrue(result.contains("ID_e20ab372c6a66256b020d616f2f16f5283df0364"))
    }
    ...
    def testX3D() {
        ...
        try {
			...
			file2 = new File("./testdata/bank/output/rd/famix/bank_hidden_privates/model.x3d")
        } catch (FileNotFoundException e) {
            e.printStackTrace
        }
    ...
    def rdNumberOfData() {
    	...
    	Assert.assertEquals(4, attributes.length)
    }
    ...
    def rd() {
    	...
    	var File file2 = null
        try {
			file1 = new File("./testdata/bank/output/rd/famix/bank_hidden_privates/rd.xml")
    ...
    def rdExtended() {
        ...
        try {
			file1 = new File("./testdata/bank/output/rd/famix/bank_hidden_privates/rdextended.xml")
