...
class Bank_AttributeDiskTest {
	...
	val static path = "./output/rd/famix/bank/bank_attribute_disks/"
	...
	def static void launch() {
		...
		json = JSONUtil::read("./testdata/bank/output/rd/famix/bank_attribute_disks/metaData.json")
	}
	...
	def testMetaData() {
		...
		try {
			...
			file2 = new File("./testdata/bank/output/rd/famix/bank_attribute_disks/metaData.json")
    ...
    */   
    ...
    def testX3D() {
        ...
        try {
			...
			file2 = new File("./testdata/bank/output/rd/famix/bank_attribute_disks/model.x3d")
        } catch (FileNotFoundException e) {
            e.printStackTrace
        }
    ...
    def rd() {
    	...
    	var File file2 = null
        try {
			file1 = new File("./testdata/bank/output/rd/famix/bank_attribute_disks/rd.xml")
    ...
    def rdExtended() {
        ...
        try {
			file1 = new File("./testdata/bank/output/rd/famix/bank_attribute_disks/rdextended.xml")
