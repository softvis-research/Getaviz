...
class AndroidPhone_CompressedTest {
	...
	def testMetaData() {
        ...
        try {
			...
			file2 = new File("./testdata/android_phone/output/rd/famix/compressed/metaData.json")
    ...
    */ 
    ...
    def testX3D() {
        ...
        try {
			...
			file2 = new File("./testdata/android_phone/output/rd/famix/compressed/model.x3d")
        } catch (FileNotFoundException e) {
            e.printStackTrace
        }
    ...
    def rd() {
    	...
    	var File file2 = null
        try {
			file1 = new File("./testdata/android_phone/output/rd/famix/compressed/rd.xml")
    ...
    def rdExtended() {
        ...
        try {
			file1 = new File("./testdata/android_phone/output/rd/famix/compressed/rdextended.xml")
