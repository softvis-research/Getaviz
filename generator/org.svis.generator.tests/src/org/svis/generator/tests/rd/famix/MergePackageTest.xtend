...
class MergePackageTest {
	...
	val static path = "./output/rd/famix/nested_package_test/merge_package/"
	...
	def static void launch() {
		...
		json = JSONUtil::read("./testdata/nested_package_test/output/rd/famix//merge_package/metaData.json")
	}
	...
	def testMetaData() {
		...
		try {
			...
			file2 = new File("./testdata/nested_package_test/output/rd/famix/merge_package/metaData.json")
    ...
    def testX3D() {
		...
		try {
			...
			file2 = new File("./testdata/nested_package_test/output/rd/famix/merge_package/model.x3d")
		} catch (FileNotFoundException e) {
			e.printStackTrace
		}
    ...
    def rdNumberOfNamespaces() {
    	...
    	Assert.assertEquals(5, namespaces.length)
    }
    ...
    def rd() {
		...
		var File file2 = null
		try {
			file1 = new File("./testdata/nested_package_test/output/rd/famix/merge_package/rd.xml")
    ...
    def rdExtended() {
		...
		var File file2 = null
		try {
			file1 = new File("./testdata/nested_package_test/output/rd/famix/merge_package/rdextended.xml")
