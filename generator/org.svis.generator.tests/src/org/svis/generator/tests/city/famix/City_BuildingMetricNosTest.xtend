...
class City_BuildingMetricNosTest {
	
	val static path = "./output/city/famix/original/android_phone/nos_color/"
	...
	def static void launch() {
		...
		CitySettings::ORIGINAL_BuildingMetric = CitySettings::Original::BuildingMetric::NOS
		*/
		SettingsConfiguration.getInstance("../org.svis.generator.tests/testdata/android_phone/input/CityBuildingMetricNosTest.properties")
		new Mwe2Launcher().run(#["../org.svis.generator.run/src/org/svis/generator/run/city/Famix2City.mwe2", "-p", "inputPath=testdata/android_phone/input/famix", "outputPath=./output/city/famix/original/android_phone/nos_color"])
		//CitySettings::ORIGINAL_BuildingMetric = CitySettings::Original::BuildingMetric::NONE
		json = JSONUtil::read("./output/city/famix/original/android_phone/nos_color/metaData.json")
	}
	...
	def testMetaData() {
		...
		var File file2 = null
		try {
			file1 = new File("./output/city/famix/original/android_phone/nos_color/metaData.json")
			file2 = new File("./testdata/android_phone/output/city/famix/original/nos_color/metaData.json")
    ...
    */ 
	...
	def testCityX3D() {
		...
		var File file2 = null
		try {
			file1 = new File("./output/city/famix/original/android_phone/nos_color/model.x3d")
			file2 = new File("./testdata/android_phone/output/city/famix/original/nos_color/model.x3d")
		} catch (FileNotFoundException e) {
			e.printStackTrace
		}
    ...
    def city2() {
    	...
    	var File file2 = null
        try {
			file1 = new File("./output/city/famix/original/android_phone/nos_color/city2.xml")
			file2 = new File("./testdata/android_phone/output/city/famix/original/nos_color/city2.xml")
        } catch (FileNotFoundException e) {
            e.printStackTrace
        }
