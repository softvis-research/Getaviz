...
class CityAFrame_FloorsAndroidPhoneTest {
	
	val static path = "./output/city/famix/aframe/floors/android_phone/"
	...
	def static void launch() {
		...
		*/
		SettingsConfiguration.getInstance("../org.svis.generator.tests/testdata/android_phone/input/CityAFrameFloorsAndroidPhoneTest.properties")
		new Mwe2Launcher().run(#["../org.svis.generator.run/src/org/svis/generator/run/city/Famix2City.mwe2", "-p", "inputPath=testdata/android_phone/input/famix", "outputPath=./output/city/famix/aframe/floors/android_phone"])
		/*
		CitySettings::BUILDING_TYPE = BuildingType.CITY_ORIGINAL
		CitySettings::OUTPUT_FORMAT = OutputFormat::X3D
		*/
		json = JSONUtil::read("./output/city/famix/aframe/floors/android_phone/metaData.json")
	}
	...
	def testMetaData() {
		...
		var File file2 = null
		try {
			file1 = new File("./output/city/famix/aframe/floors/android_phone/metaData.json")
			file2 = new File("./testdata/android_phone/output/city/famix/aframe/floors/metaData.json")
    ...
    */ 
	...
	def testCityX3D() {
		...
		var File file2 = null
		try {
			file1 = new File("./output/city/famix/aframe/floors/android_phone/model.html")
			file2 = new File("./testdata/android_phone/output/city/famix/aframe/floors/model.html")
		} catch (FileNotFoundException e) {
			e.printStackTrace
		}
    ...
    def city2() {
    	...
    	var File file2 = null
        try {
			file1 = new File("./output/city/famix/aframe/floors/android_phone/city2.xml")
			file2 = new File("./testdata/android_phone/output/city/famix/aframe/floors/city2.xml")
        } catch (FileNotFoundException e) {
            e.printStackTrace
        }
