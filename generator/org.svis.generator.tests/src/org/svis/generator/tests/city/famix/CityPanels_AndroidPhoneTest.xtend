...
class CityPanels_AndroidPhoneTest {
	...
	val static path = "./output/city/famix/panels/android_phone/"
	...
	def testMetaData() {
		...
		var File file2 = null
		try {
			file1 = new File("./output/city/famix/panels/android_phone/metaData.json")
			file2 = new File("./testdata/android_phone/output/city/famix/panels/metaData.json")
    ...
    */ 
	...
	@Test
	def testCityPanelsX3D() {
		var File file1 = null
		var File file2 = null
		try {
			file1 = new File("./output/city/famix/panels/android_phone/model.x3d")
			file2 = new File("./testdata/android_phone/output/city/famix/panels/model.x3d")
		} catch (FileNotFoundException e) {
			e.printStackTrace
		}
    ...
    def city2() {
    	...
    	var File file2 = null
        try {
			file1 = new File("./output/city/famix/panels/android_phone/city2.xml")
			file2 = new File("./testdata/android_phone/output/city/famix/panels/city2.xml")
        } catch (FileNotFoundException e) {
            e.printStackTrace
        }
