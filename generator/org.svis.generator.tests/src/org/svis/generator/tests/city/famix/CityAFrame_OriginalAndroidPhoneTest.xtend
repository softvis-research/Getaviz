...
class CityAFrame_OriginalAndroidPhoneTest {
	
	val static path = "./output/city/famix/aframe/original/android_phone/"
	...
	def static void launch() {
		...
		SettingsConfiguration.getInstance("../org.svis.generator.tests/testdata/android_phone/input/CityAFrameOriginalAndroidPhoneTest.properties")
		new Mwe2Launcher().run(#["../org.svis.generator.run/src/org/svis/generator/run/city/Famix2City.mwe2", "-p", "inputPath=testdata/android_phone/input/famix", "outputPath=./output/city/famix/aframe/original/android_phone"])
		json = JSONUtil::read("./output/city/famix/aframe/original/android_phone/metaData.json")
	}
	...
	def testMetaData() {
		...
		var File file2 = null
		try {
			file1 = new File("./output/city/famix/aframe/original/android_phone/metaData.json")
			file2 = new File("./testdata/android_phone/output/city/famix/aframe/original/metaData.json")
    ...
    */ 
	...
	def testCityX3D() {
		...
		var File file2 = null
		try {
			file1 = new File("./output/city/famix/aframe/original/android_phone/model.html")
			file2 = new File("./testdata/android_phone/output/city/famix/aframe/original/model.html")
		} catch (FileNotFoundException e) {
			e.printStackTrace
		}
    ...
    def city2() {
    	...
    	var File file2 = null
        try {
			file1 = new File("./output/city/famix/aframe/original/android_phone/city2.xml")
			file2 = new File("./testdata/android_phone/output/city/famix/aframe/original/city2.xml")
        } catch (FileNotFoundException e) {
            e.printStackTrace
        }
