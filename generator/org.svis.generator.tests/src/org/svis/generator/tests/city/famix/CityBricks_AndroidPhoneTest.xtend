...
class CityBricks_AndroidPhoneTest {

	val static path = "./output/city/famix/bricks/android_phone/"
	...
	def static void launch() {
		...
		SettingsConfiguration.getInstance("../org.svis.generator.tests/testdata/android_phone/input/CityBricksAndroidPhoneTest.properties")
		new Mwe2Launcher().run(#["../org.svis.generator.run/src/org/svis/generator/run/city/Famix2City.mwe2", "-p", "inputPath=testdata/android_phone/input/famix", "outputPath=./output/city/famix/bricks/android_phone"])
		//CitySettings::BUILDING_TYPE = BuildingType.CITY_ORIGINAL
		json = JSONUtil::read("./output/city/famix/bricks/android_phone/metaData.json")
	}
	...
	def testMetaData() {
		...
		var File file2 = null
		try {
			file1 = new File("./output/city/famix/bricks/android_phone/metaData.json")
			file2 = new File("./testdata/android_phone/output/city/famix/bricks/metaData.json")
    ...
    */ 
    ...
    @Test
    def testCityBricksX3D() {
    	var File file1 = null
        var File file2 = null
        try {
            file1 = new File("./output/city/famix/bricks/android_phone/model.x3d")
			file2 = new File("./testdata/android_phone/output/city/famix/bricks/model.x3d")
        } catch (FileNotFoundException e) {
            e.printStackTrace
        }
    ...
    def city2() {
    	...
    	var File file2 = null
        try {
			file1 = new File("./output/city/famix/bricks/android_phone/city2.xml")
			file2 = new File("./testdata/android_phone/output/city/famix/bricks/city2.xml")
        } catch (FileNotFoundException e) {
            e.printStackTrace
        }
