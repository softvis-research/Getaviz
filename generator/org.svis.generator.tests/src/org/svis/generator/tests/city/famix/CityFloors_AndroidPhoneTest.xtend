...
class CityFloors_AndroidPhoneTest {
		...
		val static path = "./output/city/famix/floors/android_phone/"
	...
	def testMetaData() {
		...
		var File file2 = null
		try {
			file1 = new File("./output/city/famix/floors/android_phone/metaData.json")
			file2 = new File("./testdata/android_phone/output/city/famix/floors/metaData.json")
    ...
    */ 
    ...
    def testCityBricksX3D() {
        ...
        var File file2 = null
        try {
            file1 = new File("./output/city/famix/floors/android_phone/model.x3d")
			file2 = new File("./testdata/android_phone/output/city/famix/floors/model.x3d")
        } catch (FileNotFoundException e) {
            e.printStackTrace
        }
    ...
    def city2() {
    	...
    	var File file2 = null
        try {
			file1 = new File("./output/city/famix/floors/android_phone/city2.xml")
			file2 = new File("./testdata/android_phone/output/city/famix/floors/city2.xml")
        } catch (FileNotFoundException e) {
            e.printStackTrace
        }
