...
class CityAFrame_BricksAndroidPhoneTest {
	
	val static path = "./output/city/famix/aframe/bricks/android_phone/"
	...
	def testMetaData() {
		...
		var File file2 = null
		try {
			file1 = new File("./output/city/famix/aframe/bricks/android_phone/metaData.json")
			file2 = new File("./testdata/android_phone/output/city/famix/aframe/bricks/metaData.json")
    ...
    */ 
	...
	def testCityX3D() {
		...
		var File file2 = null
		try {
			file1 = new File("./output/city/famix/aframe/bricks/android_phone/model.html")
			file2 = new File("./testdata/android_phone/output/city/famix/aframe/bricks/model.html")
		} catch (FileNotFoundException e) {
			e.printStackTrace
		}
    ...
    def city2() {
    	...
    	var File file2 = null
        try {
			file1 = new File("./output/city/famix/aframe/bricks/android_phone/city2.xml")
			file2 = new File("./testdata/android_phone/output/city/famix/aframe/bricks/city2.xml")
        } catch (FileNotFoundException e) {
            e.printStackTrace
        }
