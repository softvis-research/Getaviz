...
class CityOriginal_AndroidPhoneTest {
	
	val static path = "./output/city/famix/original/android_phone/"
	...
	def testMetaData() {
		...
		var File file2 = null
		try {
			file1 = new File("./output/city/famix/original/android_phone/metaData.json")
			file2 = new File("./testdata/android_phone/output/city/famix/original/metaData.json")
    ...
    */ 
	...
	def testCityX3D() {
		...
		var File file2 = null
		try {
			file1 = new File("./output/city/famix/original/android_phone/model.x3d")
			file2 = new File("./testdata/android_phone/output/city/famix/original/model.x3d")
		} catch (FileNotFoundException e) {
			e.printStackTrace
		}
    ...
    def city2() {
    	...
    	var File file2 = null
        try {
			file1 = new File("./output/city/famix/original/android_phone/city2.xml")
			file2 = new File("./testdata/android_phone/output/city/famix/original/city2.xml")
        } catch (FileNotFoundException e) {
            e.printStackTrace
        }
