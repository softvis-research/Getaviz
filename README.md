...
Have a look at our wiki which contains many additional information. Please open an issue if you have any questions or experience problems during setup or usage. Already answered questions can be found [here](https://github.com/softvis-research/Getaviz/labels/question).
...
Many thanks to all the contributors who have improved Getaviz by implementing new features or fixing bugs, especially: Denise Zilch, [André Naumann](https://github.com/sk2andy), [Stefan Faulhaber](https://github.com/StefanFaulhaber), [Dan Häberlein](https://github.com/dhaeb),  [Lisa Vogelsberg](https://github.com/Valekta/), [Aaron Sillus](https://github.com/AaronSil), [Jens Thomann](https://github.com/jt23coqi), [Vladislavs Terjaniks](https://github.com/VlaD-T), and [Christina Sixtus](https://github.com/ChristinaSi).
