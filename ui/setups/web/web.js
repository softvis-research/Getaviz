var setup = {
	...
	controllers: [	
		...
		{ 	name: 	"relationConnectorController",		
			...
			//todo create additional setups for rd and original city
			
			showInnerRelations: false, //classes in the same package will have no connectors
			
			//createEndPoints: false, //helpfull in RD
			//sourceStartAtBorder: true, //does not work in RD
			//targetEndAtBorder: true, //does not work in RD
		},
