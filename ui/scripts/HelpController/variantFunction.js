...
function relationships_Cityoriginal(){
...
function legend_Citybricks(){            
    ...
    function relationships_Citybricks(){         
    ...
    function relationships_Cityfloor(){         
 ...
 function navigation() {
     ...
     return {
        ...
        relationships_RD: relationships_RD,
 		legend_RD: legend_RD,
 		relationships_Cityfloor:relationships_Cityfloor,
 		legend_Cityfloor: legend_Cityfloor,
 		relationships_Citybricks:relationships_Citybricks,
 		legend_Citybricks: legend_Citybricks,
 		relationships_Cityoriginal:relationships_Cityoriginal,
 		legend_Cityoriginal:legend_Cityoriginal,
 		helpPopupUl:helpPopupUl
 	};
})();
