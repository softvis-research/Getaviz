var helpController = (function() {
	...
	function activate(){
        ...
        $("#jqxHelpButton").on('click', function (){
            ...
            var helpPopupUl = "<ul class='helpPopupUl'><li><div><img src='scripts/HelpController/images/category.png'><div class='helpPopup_Ul_div'>Legend</div></div></li><li><div><img src='scripts/HelpController/images/mouse.png'><div class='helpPopup_Ul_div'>Navigation</div></div></li></ul>";
            ...
            if(controllerConfig.Metaphor=="RD") {
                ...
                helpPopup = "<div id='legendTabs'>" + helpPopupUl + helpPopup_Legend + helpPopup_Navigation + "</div>";
            }; 
