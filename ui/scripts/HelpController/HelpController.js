var helpController = (function() {
	...
	function activate(){
        ...
        $("#jqxHelpButton").on('click', function (){
            ...
            var relationships_Cityoriginal= "<div class='relationships_City_Div City_Relationships'><h2>Inheritance</h2><img src='scripts/HelpController/images/cityoriginal_inheritance.png' ></div>";
            
            var relationships_Citybricks= "<div class='relationships_Citybricks_Div City_Relationships'><h2>Field accesses</h2><img src='scripts/HelpController/images/citybricks_void.png' ><h2>Method calls</h2><img src='scripts/HelpController/images/citybricks_credits.png' ></div>";
            
            var relationships_Cityfloor= "<div class='relationships_Cityfloor_Div City_Relationships'><h2>Field accesses</h2><img src='scripts/HelpController/images/cityfloor_void.png' ><h2>Method calls</h2><img src='scripts/HelpController/images/cityfloor_credits.png' ></div>";
            
            var relationships_RD= "<div class='relationships_RD_Div City_Relationships'><h2>Inheritance</h2><img src='scripts/HelpController/images/RD_abstract.png' ><h2>Field accesses</h2><img src='scripts/HelpController/images/RD_void.png' ><h2>Method calls</h2><img src='scripts/HelpController/images/RD_voidrun.png' ></div>";
            
            var navigation_Aframe = "<div><div class='navigation_Aframe_01 city_Navigation'><h2>Rotate</h2><img src='scripts/Legend/images/left.png'><p>The city metaphor is a 3 dimensional real-world metaphor, aimed at creating a better understanding of the visualized system through a natural environment.</p></div><div class='navigation_Aframe_02 city_Navigation'><h2>Move</h2><img src='scripts/Legend/images/middle.png' ><p>The city metaphor is a 3 dimensional real-world metaphor, aimed at creating a better understanding of the visualized system through a natural environment.</p></div><div class='navigation_Aframe_03 city_Navigation'><h2>Zoom</h2><img src='scripts/Legend/images/scrolling.png'><p>The city metaphor is a 3 dimensional real-world metaphor, aimed at creating a better understanding of the visualized system through a natural environment.</p></div></div>";
         
            var navigation_RD = "<div><div class='navigation_RD_01 city_Navigation'><h2>Rotate</h2><img src='scripts/Legend/images/left.png'><p>The city metaphor is a 3 dimensional real-world metaphor, aimed at creating a better understanding of the visualized system through a natural environment.</p></div><div class='navigation_RD_02 city_Navigation'><h2>Center</h2><img src='scripts/Legend/images/double.png'><p>The city metaphor is a 3 dimensional real-world metaphor, aimed at creating a better understanding of the visualized system through a natural environment.</p></div><div class='navigation_RD_03 city_Navigation'><h2>Move</h2><img src='scripts/Legend/images/middle.png' ><p>The city metaphor is a 3 dimensional real-world metaphor, aimed at creating a better understanding of the visualized system through a natural environment.</p></div><div class='navigation_RD_04 city_Navigation'><h2>Zoom</h2><img src='scripts/Legend/images/scrolling.png'><p>The city metaphor is a 3 dimensional real-world metaphor, aimed at creating a better understanding of the visualized system through a natural environment.</p></div></div>";
