...
ActiveRecord::Schema.define(version: 2016_10_02_202724) do

  create_table "answer_possibility_collections", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "experiment_steps", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "position"
  ...
  create_table "experiment_surveys", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "survey_id"
    t.integer "scene_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "experiments", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "title"
    t.text "description"
    t.string "id_hash"
  ...
  create_table "participant_experiment_step_answers", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.text "answer"
    t.integer "question_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "participant_experiment_step_scenes", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "scene_id"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer "participant_experiment_step_id"
  ...
  create_table "participant_experiment_steps", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "question_options", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "answer"
    t.integer "question_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "questionaire_questions", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "scene_test_scenes", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "scene_tests", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "title"
    t.text "description"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "scenes", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "name"
  ...
  create_table "step_scenes", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "step_id"
    t.integer "scene_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "step_textual_elements", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "step_id"
  ...
  create_table "test_questions", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "test_id"
    t.integer "question_id"
    t.integer "position"
    t.datetime "created_at"
  ...
  create_table "tests", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "title"
    t.string "description"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "texts", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.text "html"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string "title"
  ...
  create_table "textual_elements", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "title"
    t.string "description"
    t.text "html"
